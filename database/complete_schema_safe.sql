-- Pokemon Card Scanner Database Schema - Safe Version
...
-- ============================================================================
-- USER ALBUMS TABLE (NEW)
-- ============================================================================
-- Store user's custom albums for organizing cards
...
-- ============================================================================
-- ALBUM CARDS TABLE (NEW)
-- ============================================================================
-- Junction table for album-card relationships
...
DROP POLICY IF EXISTS "Users can manage own collection" ON public.user_collections;
DROP POLICY IF EXISTS "Users can manage own albums" ON public.user_albums;
DROP POLICY IF EXISTS "Users can view public albums" ON public.user_albums;
DROP POLICY IF EXISTS "Users can manage own album cards" ON public.album_cards;
DROP POLICY IF EXISTS "Users can view album cards" ON public.album_cards;
DROP POLICY IF EXISTS "Users can manage own wishlist" ON public.user_wishlists;
...
DROP TRIGGER IF EXISTS update_pokemon_cards_updated_at ON public.pokemon_cards;
DROP TRIGGER IF EXISTS update_user_collections_updated_at ON public.user_collections;
DROP TRIGGER IF EXISTS update_user_albums_updated_at ON public.user_albums;
...
DO $$
BEGIN
  RAISE NOTICE 'Pokemon Card Scanner database schema has been successfully set up!';
  RAISE NOTICE 'Tables created: user_profiles, pokemon_sets, pokemon_cards, user_collections, user_albums, album_cards, user_wishlists, user_watchlists, price_history, scan_history, notifications';
  RAISE NOTICE 'RLS policies configured for security';
  RAISE NOTICE 'Sample data inserted for testing';
  RAISE NOTICE 'Your album functionality is now ready to use!';
END $$;
